...
struct DefalutFoodCategory {
    ...
    static func generateDefaultCategory() -> [DefalutFoodCategory] {
        ...
        defaultFoodCategories.append(DefalutFoodCategory(name: "Dry Spices & Condiment", iconString: "🧂", subtitle: "Dried spices and herbs can last for about 1-4 years.\nFresh herbs and spices, on the other hand, generally lasts for about 1-2 weeks in the fridge.\nCondiments generally last indefinitely, but it is suggested to follow the use by date provided in the packaging.", estimation: "Follow the use by/expiry date written on the label of the packaging", expiryEstimation: 365))
        //copy
        defaultFoodCategories.append(DefalutFoodCategory(name: "Fresh Herbs & Spices", iconString: "🌿", subtitle: "Dried spices and herbs can last for about 1-4 years.\nFresh herbs and spices, on the other hand, generally lasts for about 1-2 weeks in the fridge.\nCondiments generally last indefinitely, but it is suggested to follow the use by date provided in the packaging.", estimation: "Follow the use by/expiry date written on the label of the packaging", expiryEstimation: 365))
        //copy
        defaultFoodCategories.append(DefalutFoodCategory(name: "Bread & Pastry", iconString: "🍞", subtitle: "Snacks can last for about 1-4 years.", estimation: "Follow the use by/expiry date written on the label of the packaging", expiryEstimation: 365))
        //copy
        defaultFoodCategories.append(DefalutFoodCategory(name: "Egg", iconString: "🥚", subtitle: "Snacks can last for about 1-4 years.", estimation: "Follow the use by/expiry date written on the label of the packaging", expiryEstimation: 365))
        ...
        //copy
        defaultFoodCategories.append(DefalutFoodCategory(name: "Alcoholic Drinks", iconString: "🍺", subtitle: "Snacks can last for about 1-4 years.", estimation: "Follow the use by/expiry date written on the label of the packaging", expiryEstimation: 365))
        //copy
        defaultFoodCategories.append(DefalutFoodCategory(name: "Snacks", iconString: "🍟", subtitle: "Snacks can last for about 1-4 years.", estimation: "Follow the use by/expiry date written on the label of the packaging", expiryEstimation: 365))
        ...
        //copy
        defaultFoodCategories.append(DefalutFoodCategory(name: "Instant Food", iconString: "🍜", subtitle: "Canned and dried food can last for months, if not years. Dried food can last long because of the lack of water, which inhibits bacterial growth.\nCanned food can last indefinitely as long as the can is kept in good condition, in a dark and cool place.\nAlthough canned and dried food may last indefinitely, it may experience a change in flavor or texture, and the nutritional value may also deteriorate over time.\nGenerally, you should follow the use by date provided at the packaging.", estimation: "Follow the use by/expiry date written on the label of the packaging", expiryEstimation: 365))
        //copy
